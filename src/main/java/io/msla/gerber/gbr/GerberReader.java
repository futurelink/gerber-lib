...
import io.msla.gerber.gbr.cmd.*;
import io.msla.gerber.gbr.cmd.a.*;
import io.msla.gerber.gbr.cmd.d.*;
import io.msla.gerber.gbr.cmd.g.*;
import io.msla.gerber.gbr.cmd.l.*;
import io.msla.gerber.gbr.cmd.t.*;
...
public class GerberReader {
    private final static Logger log = Logger.getLogger(GerberReader.class.getName());
    ...
    public final Gerber read(String name) throws IOException, GerberException {
        ...
        if (cmdCount == 0) throw new GerberException("Not a Gerber file, didn't manage to read commands");
